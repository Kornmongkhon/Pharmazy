...
(8, 'EVE\'S HORSE PLACENTA 15 ml.', 'EVE\'S เซรั่มรกม้า เซรั่มอีฟส์ เซรั่ม บำรุงผิวหน้า ผู้ชาย ผิวหน้าขาว กระจ่างใส ลดรอยสิว ฝ้า กระ จุดด่างดำ หมองคล้ำ อีฟส์ สุดยอดผลิตภัณฑ์บำรุงผิวหน้า ด้วยสารสกัด Horse Placenta จากม้าสายพันธุ์ Thoroughbred ซี่งเป็นสายพันธุ์ม้าแข่งที่ดีที่สุดของประเทศนิวซีแลนด์ ผ่านกรรมวิธีการสกัดด้วยผู้เชี่ยวชาญ และเทคโนโลยีทันสมัยจากประเทศญี่ปุ่น ที่อุดมไปด้วยสารอาหารบำรุงผิวมากมาย อาทิเช่น Amino Acid ซึ่งมีมากกว่าถึง 300 เท่า เมื่อเปรียบเทียบกับปริมาณ Amino Acid ที่ได้จากรกแกะ พร้อมเข้าบำรุงผิวของคุณอย่างลํ้าลึก เสมือน Growth Factor ที่ช่วยบำรุงให้โครงสร้างชั้นผิวค่อยๆ แข็งแรงขึ้น อีกทั้งยังช่วยเติมนํ้าให้ ผิวนุ่มชุ่มชื้น รูขุมขนแลดูกระชับ เรียบเนียน ซึ่งมาในรูปแบบของ Essense ซึมซาบเร็ว ไม่เหนียวเหนอะหนะ', 790, 'skin-care', 0, 'assets/product/eve.jpg', 22),
